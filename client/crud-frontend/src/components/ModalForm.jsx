...
export default function ModalForm({ isOpen, onClose, mode, OnSubmit, clientData }) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            // Create client data object to submit
            const clientData = { name, email, job, rate: Number(rate), isactive: status };
            await OnSubmit(clientData);  // Pass data to parent for submit handling
    ...
    useEffect(() => {
        // If mode is 'edit' and clientData is passed, pre-fill the form fields
